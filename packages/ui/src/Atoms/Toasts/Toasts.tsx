...
const toastStyles = tv({
  slots: {
    wrapper:
            "relative overflow-hidden bg-level-1 border border-border-solid rounded-md shadow-dialog animate-in slide-in-from-bottom-3 fade-in-0 duration-200 ease-[var(--ease-out-expo)]",
    icon: "flex-none mt-0.5",
    timer: "absolute bottom-0 left-0 h-[2px] starting:scale-x-0 scale-x-100 origin-left transition-transform ease-linear rounded-b-md",
