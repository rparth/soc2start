...
export const dropzone = tv({
  slots: {
    wrapper:
            "bg-subtle border border border-border-low p-2 rounded-md outline-none  focus-visible:shadow-focus",
    zone: "bg-secondary min-h-46 border border-border-low border-dashed rounded-md flex items-center justify-center",
