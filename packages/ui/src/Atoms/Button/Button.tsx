...
export const button = tv({
  base: "flex items-center justify-center gap-[6px] px-6 py-3 rounded-md cursor-pointer text-sm font-semibold focus:outline-none whitespace-nowrap w-max transition-all duration-150",
  variants: {
    variant: {
      primary:
