...
export const dialog = tv({
  slots: {
    ...
    content:
            "text-txt-secondary text-sm fixed inset-0 m-auto z-50 h-max bg-level-2 rounded-none sm:rounded-lg w-full sm:w-[95%] sm:max-w-5xl max-h-[100dvh] sm:max-h-[90dvh] shadow-dialog duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-top-5 data-[state=open]:slide-in-from-top-5",
