...
var seedFrameworks = []seedFramework{
	...
	},
	{
		...
		Controls: []seedControl{
			...
			{"CC7.3", "Incident Detection", "The entity evaluates security events to determine whether they constitute incidents"},
			{"CC7.4", "Incident Response", "The entity responds to identified security incidents"},
			{"CC7.5", "Incident Recovery", "The entity identifies and recovers from security incidents"},
			{"CC8.1", "Change Management Controls", "The entity authorizes, designs, develops, configures, documents, tests, approves, and implements changes"},
			{"CC9.1", "Risk Mitigation", "The entity identifies, selects, and develops risk mitigation activities"},
			{"CC9.2", "Vendor Risk Management", "The entity assesses and manages risks associated with vendors and partners"},
			{"A1.1", "Availability Commitments", "The entity maintains, monitors, and evaluates current processing capacity and availability"},
			{"A1.2", "Recovery Planning", "The entity authorizes, designs, develops, and implements recovery activities"},
			{"A1.3", "Recovery Testing", "The entity tests recovery plan procedures"},
			{"C1.1", "Confidential Information Identification", "The entity identifies and maintains confidential information"},
			{"C1.2", "Confidential Information Disposal", "The entity disposes of confidential information"},
			{"P1.1", "Privacy Notice", "The entity provides notice about its privacy practices"},
		},
	},
	{
		Name:        "GDPR",
...
var seedMeasures = []seedMeasure{
	...
	{"Application Security Policy", "POLICY"},
	{"Availability Policy", "POLICY"},
	{"Business Continuity Policy", "POLICY"},
	{"Change Management Policy", "POLICY"},
	{"Code of Conduct Policy", "POLICY"},
	{"Confidentiality Policy", "POLICY"},
	{"Cybersecurity Policy", "POLICY"},
	{"Datacenter Security Policy", "POLICY"},
	{"Disaster Recovery Policy", "POLICY"},
	{"Encryption Policy", "POLICY"},
	{"Log Management Policy", "POLICY"},
	{"Password Policy", "POLICY"},
	{"Privacy Policy", "POLICY"},
	{"Data Retention Policy", "POLICY"},
	{"Remote Access Policy", "POLICY"},
	{"Risk Assessment Policy", "POLICY"},
	{"Vendor Management Policy", "POLICY"},
	{"Workstation Security Policy", "POLICY"},
	...
	{"Employee Onboarding Security Procedure", "ORGANIZATIONAL"},
	{"Employee Offboarding Security Procedure", "ORGANIZATIONAL"},
	{"Patch Management Procedure", "ORGANIZATIONAL"},
}
